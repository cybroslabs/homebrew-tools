...
cask "ouroctl" do
  version "ouroctl-v2.1.7"

  on_macos do
    on_intel do
      sha256 "c96daf943fe2e1267b8be5f1cc0e91bd6cf29a24e24a319393a575a8679bceb3"
    ...
    on_arm do
      sha256 "ba3eadf8c0cda0e79f6d910907e1d1ce485fff72cccd04d2f77e61ce3b262b81"
  ...
  on_linux do
    on_intel do
      sha256 "cb652d72bbc232694c13875e2f83a5dece6b4c26a22b07dfdf96b80b43fd7ac4"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "219840515cba707b49127803e94a9e1c0eb1c49f046485934ffcc8afcc767a4d"
