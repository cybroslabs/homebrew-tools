...
cask "ouroctl" do
  version "ouroctl-v2.1.9"

  on_macos do
    on_arm do
      sha256 "d7b476ef67a6ca4c0a97b46d22da36f338ff5e9fcdc7abac085b84be48ea76d2"
    ...
    on_intel do
      sha256 "7b869d1731aab67d9622135d40ae7b78bb04d69bd5de0f2b659920b67abf7eb9"
  ...
  on_linux do
    on_arm do
      sha256 "0fa5ce4dcf5a371902fe7177155cfb25de2dac047fd1e68842783ff1d093f258"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_arm64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_intel do
      sha256 "a14f59893a984172352ce78ae80001ba70e5b56299c843ae7376839b15c211d6"
