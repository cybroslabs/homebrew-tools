...
cask "ouroctl" do
  version "ouroctl-v0.28.10"

  on_macos do
    on_intel do
      sha256 "0f51bcdeb58cca99b6129788f4088c45fa63708d83c029b2d612bbfa389ec007"
    ...
    on_arm do
      sha256 "ed10d3458d6bacffbb7080e4dad947e7e27d24f3e5418bc04ac2c49eab278731"
  ...
  on_linux do
    on_intel do
      sha256 "ec489d29e2747dad95654f49ca6a44ac4c2c73a691438f13264acc1b4d9779bf"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "359c245f2147e1e00a695be716da8f81d461f31847f69c96412de334a481452c"
