...
cask "ouroctl" do
  version "ouroctl-v1.0.6"

  on_macos do
    on_intel do
      sha256 "a4bd78fc127d5536df456bc6e32999c5f52ad36722150e258eadfbb7dcfd62ce"
    ...
    on_arm do
      sha256 "b7ab015d13e02e4b21ac6ddbc3330951b516336b6bfdd4e20a52b69e7fc8681c"
  ...
  on_linux do
    on_intel do
      sha256 "137bc09bbe231cfbc437ad8c3a817be261ef683002f3a378fda88b1f991d3cc3"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "401584ef70c50cc3a357a909b6966f7cd25f0358500a560b51bbea66096b97e6"
