...
cask "ouroctl" do
  version "ouroctl-v2.1.4"

  on_macos do
    on_intel do
      sha256 "623b9d764c4b485072ea78325fdd6d90b59be4a3fa7e6ff8f41f57dfd293f13b"
    ...
    on_arm do
      sha256 "45849477cb24b990398c12d32c3e99dac45534029a1e6b3d928b244accc6db4d"
  ...
  on_linux do
    on_intel do
      sha256 "9b05d0eef13f906214adb91b730c6dff0f4b75c168c0bc6f5b0923bb65eff98f"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "08831acc83b9fad06d96f051744ab267acfdcf0a6dc7a04ff275c8f76be42b91"
