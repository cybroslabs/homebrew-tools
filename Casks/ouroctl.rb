...
cask "ouroctl" do
  version "ouroctl-v0.28.20"

  on_macos do
    on_intel do
      sha256 "1af8ca4a102a8e66e056bcaee53da501729ed5aac9b928f0182d98af8dc66cbc"
    ...
    on_arm do
      sha256 "4e28a82593d587e63d03940422d2dc5a67741857edbac1e653b9866231726f39"
  ...
  on_linux do
    on_intel do
      sha256 "fa41f687765e6d7376587850d0364e40f75bed61c5a22ddac90a1624b6af7ede"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "108f433f570469193f1987fcb65945e55c8b3b932383b23614f4c9f646bda068"
