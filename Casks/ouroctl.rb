...
cask "ouroctl" do
  version "ouroctl-v2.1.3"

  on_macos do
    on_intel do
      sha256 "ff341bdafc680e8779482e393a1ffde7148bbf107bba7b036df91f9a34e090be"
    ...
    on_arm do
      sha256 "3a37d0a1e6950f48cb799861f72aae05475d4fe6924db7e79c7e2407730ef06d"
  ...
  on_linux do
    on_intel do
      sha256 "06daf8ce85f4a8f291dfdbb8481a5664fdc902958aca1176b449f6e6e0747218"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "3bef2e7a15c0604b155bb00ba27de30790c0e1a6f90716578da9fb457fac16c8"
