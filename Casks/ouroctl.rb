...
cask "ouroctl" do
  version "ouroctl-v0.28.16"

  on_macos do
    on_intel do
      sha256 "a0a536b7a9e814532a8bf08cc7a8878c404f0efda422ace7615bd7b851689188"
    ...
    on_arm do
      sha256 "943c27d810936fd57671fe54c0865860c55d6dd31b652ca1df7b0bcecf957a42"
  ...
  on_linux do
    on_intel do
      sha256 "8319a3eac78bc1d6291f504063fc1191af0bd4924f35125a6279d43a8f3af501"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "2fb4bc853aface765daa1442be3c06c5b17a5949f7662b1b5758c47456b23276"
