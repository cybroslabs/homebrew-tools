...
cask "ouroctl" do
  version "ouroctl-v2.1.22"

  on_macos do
    on_arm do
      sha256 "19693a1023ad697769769c3203af47bf685a11cd62b9a435ce92714f0f33b159"
    ...
    on_intel do
      sha256 "1ced2dfcafd219ec45f522b23fa620fbdcd627676155a023e4b2d6c5ac5b2e63"
  ...
  on_linux do
    on_arm do
      sha256 "9ce469ea2e3ea1e7f90dca2af02f8125bfcc4db65f99c884ca06c4d25175e04a"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_arm64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_intel do
      sha256 "14981584fa67f639c2f145d85f7e49e8ed2794be327644c19480bfc546bf6709"
