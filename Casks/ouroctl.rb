...
cask "ouroctl" do
  version "ouroctl-v0.31.2"

  on_macos do
    on_intel do
      sha256 "bb8ed8851c6596b02f260b9cab9ee9da03232704f0b901e793fea894fe3d6be6"
    ...
    on_arm do
      sha256 "4f8e05ab3afd6391711a1f076c1de45b971e2fd756c3eeaafca3fa7ad3a3bff1"
  ...
  on_linux do
    on_intel do
      sha256 "c6409ed1e4e49b8d0942238ed386bfc5bec1357809d1b1a21d51e74b0619bbb1"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "014818d3ddcc34a46455a58c6648f06025f71ab849c2fde5d453fddbf060c4a9"
