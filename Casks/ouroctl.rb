...
cask "ouroctl" do
  version "ouroctl-v0.29.1"

  on_macos do
    on_intel do
      sha256 "ecca02996062be92de70972c5d7524afd87e06c1df1a131dc1e95d4b53f1ecb3"
    ...
    on_arm do
      sha256 "7675a15a9e9860878c3e0e305970988517e19196aebf0b0cc30e4bb99d9ccc04"
  ...
  on_linux do
    on_intel do
      sha256 "1cdcb0690131a82b3106c399693b8b105ceb0981a5262b82ef3ad97644327676"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "a98facba2a4fb5f3a064d28e8442569422baa9560f7690a32db4c28f1187e7a5"
