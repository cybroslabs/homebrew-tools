...
cask "ouroctl" do
  version "ouroctl-v0.28.12"

  on_macos do
    on_intel do
      sha256 "1d5bfe2d8ca541163be4a0e73410d0679da260943f7adcb81a009eb9a0d4a5d6"
    ...
    on_arm do
      sha256 "6f767cd64c2d363830a1269f6e2515b6e3189a19e8155af7418eacf84948f052"
  ...
  on_linux do
    on_intel do
      sha256 "ef5fe60717510ee3550478c4273682c3dfd854267aeda37bd2546cef440efde7"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "fa93bf797db7f5433b2c7942cbc8fb1ebf0f5b0a33a35e978fb3499d7d9db5d6"
