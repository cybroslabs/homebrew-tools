...
cask "ouroctl" do
  version "ouroctl-v0.28.14"

  on_macos do
    on_intel do
      sha256 "d1eb8dc71a571724adbf056c1ec1dcfb20ad7f5ccafe57afb5bf12cd3b25b237"
    ...
    on_arm do
      sha256 "b7a7a26053acbc538855c6f7349f0446bc892ed62075536bbe99aafd377dbfb1"
  ...
  on_linux do
    on_intel do
      sha256 "b3273ba1bee916b5c4b8108893f6145f7978cfb6e8f410eab8119df394eccd84"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "fabf9b5be319e1d3934bf1d3a91fd5b1e36b1dd90d70685a5bdc7c1afddd72fc"
