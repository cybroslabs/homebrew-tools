...
cask "ouroctl" do
  version "ouroctl-v2.1.20"

  on_macos do
    on_arm do
      sha256 "c9e15fe3be693f73e47227411e515a15d2399bbb340c1ffca7918d96ac8f801d"
    ...
    on_intel do
      sha256 "abf84df5b19e6a7dd2637cd8f245f23b5fe12fcf0745b414fae34c115291a8ed"
  ...
  on_linux do
    on_arm do
      sha256 "320aa5ffb1dcf7549d38dd73acdeecaa783df1b064417407a625099a6f32d11b"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_arm64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_intel do
      sha256 "0aa9e6b63986b9cba76839572ab11b3c94dbdf86f20eb5459ef979c77ef1c851"
