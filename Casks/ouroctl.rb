...
cask "ouroctl" do
  version "ouroctl-v0.28.15"

  on_macos do
    on_intel do
      sha256 "ffd876362bb4f76a7cb00ffa133de398d57c488cf38bb756bc2221383e3ca82a"
    ...
    on_arm do
      sha256 "a94785e0d815e19c50fc08c57c1e2199fafb99870dd151ae0b4a5fee233a6597"
  ...
  on_linux do
    on_intel do
      sha256 "3a5d74520c7254e1fe60521c4f8bd1eb77e21d5d1d545b390aff97ff80b17a95"
      url "https://github.com/cybroslabs/homebrew-tools/releases/download/#{version}/ouroctl_Linux_x86_64.tar.gz",
        verified: "github.com/cybroslabs/homebrew-tools"
    end
    on_arm do
      sha256 "804762ec9fd1430555ca874dae561a9ad306572445be9fc9283868bdf0e7d5ec"
