...
```
  # Generate report filtering by status bit 0 (StatusBitsCriticalError)
  ouroctl report dataquality --output json --file dataquality.json --from 2025-06-27T00:00:00 --to 2025-06-27T10:00:00 --status 0

  # Filter by multiple status bits (comma-separated or multiple flags)
